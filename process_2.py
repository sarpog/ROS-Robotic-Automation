...
#Q14.1 = [-0.905, 0.444, -0.22, 0, -0.74, -0.31] 
Q15 = [-0.905, 0.444, -0.2, 0, -0.78, -0.31] 
#Q15 = [-0.905, 0.43, -0.25, 0, -0.685, -0.31] 
Q16 = [0, 0, 0, 0, -1.55, 0]  

#Q17 = [-0.005, 0.033, -0.464, 0, -0.969, 0] 
Q17 = [-0.005, 0.057, -0.43, 0, -1.017, 0]
#Q17 = [-0.005, 0.035, -0.43, 0, -1.025, 0]

#Q18 = [-0.005, 0.08, -0.42, 0, -1.02, 0] 
...
def main():
    ...
    try:
         ...
         goal.trajectory.points = [
             ...
             JointTrajectoryPoint(positions=Q14, velocities=[0]*6, time_from_start=rospy.Duration(5.0)),
             JointTrajectoryPoint(positions=Q13, velocities=[0]*6, time_from_start=rospy.Duration(13.0))]
    ...
    try:
         ...
         joints_pos = joint_states.position
         goal.trajectory.points = [
             JointTrajectoryPoint(positions=joints_pos, velocities=[0]*6, time_from_start=rospy.Duration(22.0)),
             JointTrajectoryPoint(positions=Q15, velocities=[0]*6, time_from_start=rospy.Duration(32.0)),
             JointTrajectoryPoint(positions=Q11, velocities=[0]*6, time_from_start=rospy.Duration(40.0)),
             JointTrajectoryPoint(positions=Q16, velocities=[0]*6, time_from_start=rospy.Duration(48.0)),
             JointTrajectoryPoint(positions=Q17, velocities=[0]*6, time_from_start=rospy.Duration(56.0))]
    ...
    try:
         ...
         joints_pos = joint_states.position
         goal.trajectory.points = [
             JointTrajectoryPoint(positions=joints_pos, velocities=[0]*6, time_from_start=rospy.Duration(61.0)),
             JointTrajectoryPoint(positions=Q0, velocities=[0]*6, time_from_start=rospy.Duration(67.0))]
